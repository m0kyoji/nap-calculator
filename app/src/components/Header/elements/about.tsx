  ...
  return (
      <>
        <div
            ...
            className={ 'w-full h-full fixed top-0 left-0 right-0 z-40 p-2 sm:pt-12 bg-slate-300 bg-opacity-70' }
        >
        </div>
        <div
            className={ 'fixed left-0 right-0 m-auto p-10 max-w-lg mx-auto w-full flex flex-col gap-8 items-center bg-white rounded-3xl shadow-lg' }
            style={ { zIndex: 41 } }
        >
          <QA title={ '何ができる？' }>
            <div>
          ...
          <QA title={ 'どうやって計算しているの？' }>
            <div>
              ...
              <p style={ { fontFeatureSettings: "palt" } }>
                おひる寝計算機では、選択された島と入力されたカビゴンパワーを元にねむけパワーを計算し、基準値と照らし合わせることで出会うことができる最大匹数を推定しています。
              </p>
            </div>
            <div className={ 'mt-4 bg-gray-50 rounded-xl p-3 text-sm' }>
